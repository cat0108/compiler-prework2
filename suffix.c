...
static const char *const yytname[] =
{
  ...
  "MINUS", "MUL", "DIV", "left_paren", "right_paren", "UMINUS", "';'",
...
#line 40 "suffix.y"
                              {yyval = (char*)malloc(strlen(yyvsp[-2])+strlen(yyvsp[-1])+strlen(yyvsp[0])+1);strcpy(yyval,yyvsp[-2]),strcat(yyval,yyvsp[0]),strcat(yyval,"+");free(yyvsp[-2]),free(yyvsp[0]);}
#line 1156 "suffix.c"
    break;
...
#line 45 "suffix.y"
                                        {yyval = (char*)malloc(strlen(yyvsp[-1])+strlen(yyvsp[0])+1);strcpy(yyval,"-"),strcat(yyval,yyvsp[0]);free(yyvsp[0]);}
#line 1186 "suffix.c"
    break;

  case 11: /* expr: NUMBER  */
#line 46 "suffix.y"
                       {yyval = (char*)malloc(strlen(yyvsp[0])+1);strcpy(yyval,yyvsp[0]);free(yyvsp[0]);}
#line 1192 "suffix.c"
    break;
